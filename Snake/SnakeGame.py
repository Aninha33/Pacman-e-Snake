...
class SnakeGame:
    ...
    def __init__(self, seed):
        ...
        self.fruitDistance = abs(self.snake_position[0] - self.fruit_position[0]) + abs(self.snake_position[1] - self.fruit_position[1])
    ...
    def show_score(self, choice, color, font, size):
        ...
        # Mais pontuação enquanto mais vive
        self.endTime = time.time()
        self.score += int(10*(self.endTime - self.startTime))

        # create the display surface object (score_surface)
        score_surface = score_font.render('Score : ' + str(int(self.score)), True, color)
    ...
    def game_over(self):
        ...
        game_over_surface = my_font.render(
            'Your Score is : ' + str(int(self.score)), True, red)
    ...
    def run(self):
        ...
        while True:
            ...
            if index < len(self.moves):
                self.change_to = self.moves[index]
                index += 1
            ...
            for pos in self.snake_body:
                pygame.draw.rect(self.game_window, corzinhas(), pygame.Rect(pos[0], pos[1], 10, 10))
            ...
            if self.snake_position[0] < 0 or self.snake_position[0] > self.window_x-10:
                self.endTime = time.time()
                self.score -= 50 # Penalidade
                return self.score, self.qtyFoods
                #self.game_over()
